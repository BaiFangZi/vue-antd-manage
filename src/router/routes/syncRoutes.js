            ...
            children: [
              {
                ...
                name: 'Page2-1',
                component: () =>
                  import('@/views/demo/infinitePage/page2/page2-1'),
                meta: {
                  title: 'page2-1',
                  icon: '',
                  auth: ['admin', 'normal'],
              ...
              },
              {
                ...
                name: 'Page2-2',
                component: () =>
                  import('@/views/demo/infinitePage/page2/page2-2'),
                meta: {
                  title: 'page2-2',
                  icon: '',
                  auth: ['admin', 'normal'],
            ...
            children: [
              {
                ...
                name: 'Page3-1',
                component: () =>
                  import('@/views/demo/infinitePage/page3/page3-1'),
                meta: {
                  title: 'page3-1',
                  icon: '',
                  auth: ['admin', 'normal'],
              ...
              },
              {
                ...
                name: 'Page3-2',
                component: () =>
                  import('@/views/demo/infinitePage/page3/page3-2'),
                meta: {
                  title: 'page3-2',
                  icon: '',
                  auth: ['admin', 'normal'],
                ...
                children: [
                  {
                    ...
                    component: () =>
                      import(
                        '@/views/demo/infinitePage/page3/page3-2/page3-2-1'
                      ),
                    meta: {
                      title: 'page3-2-1',
                      icon: '',
